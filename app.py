...
if __name__ == '__main__':
    print("Initializing Smart Home Simulation Instances...")
    
    room_name = "Living Room"
    rooms[room_name] = RoomController(room_name)
    sensors_dict[room_name] = RoomSensors(room_name, base_temp=25.0)
    
    sensors_dict[room_name].add_observer(rooms[room_name])
